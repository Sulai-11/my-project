...
if (empty($_SESSION['smart_exam_questions'][$course_code])) {
    die("انتهت جلسة الاختبار الذكي. ارجع للمهارة وابدأ الاختبار من جديد.");
}
...
if ($percentage < 50) {
    $levelText = 'مبتدئ';
    $recommendation = "تحتاج مراجعة أساسيات المهارة قبل الانتقال للتطبيقات. ركّز على المفاهيم الأولى ثم أعد الاختبار.";
